...
title-slide-attributes:
    data-background-image: /resources/images/background-bikeshare.png
...
B.S.
in Mathematics & B.B.A. in Economics\
...
This course will teach you the fundamentals of linear models---*simple linear regression, multiple linear regression, and analysis of variance*---and experimental design.
You will extend the concepts covered in your Stat I course, to:
